    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given blocknet address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The blocknet address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "blocknet-cli and the GUI. There is no server-side difference.",
                {},
                RPCResults{},
                RPCExamples{""},
            }.ToString()
